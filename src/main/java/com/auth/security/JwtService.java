...
public class JwtService {
    ...
    private String buildToken(UserDetails user, Map<String, Object> clamis) {
        clamis.put("username", user.getUsername());
        clamis.put("role", user.getAuthorities().stream().findFirst().map(Objects::toString).orElse("User"));
        return Jwts
                .builder()
                .claims(clamis)
